...
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000',
                        'http://localhost:5085',
                        'http://127.0.0.1:8000',
                        'http://127.0.0.1:5085'] + [os.environ.get('CSRF_TRUSTED_ORIGIN')]
...
# docker run --name deeplearning-postgres -e POSTGRES_PASSWORD=password -e POSTGRES_DB=asrSummaryDB -e POSTGRES_USER=summaryDBAccess -p 5432:5432 -d postgres

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME':  'asrSummaryDB',
        "USER": "summaryDBAccess",
        "PASSWORD": "password",
        "HOST": "database",
        "PORT": "5432",
    }
